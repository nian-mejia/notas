...
- **Nominal**
	- Este nivel se utiliza cuando los valores en los que se mide la variable son códigos que representan la ==pertenencia a una categoría, pero no tienen un orden==.

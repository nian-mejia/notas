...
- #### Pertenece y no pertenece
	- Si A es un conjunto, decimos que a **pertenece** a  **A** y escribimos a ∈ A ∈A, si aa es un elemento de AA. En caso contrario decimos que aa **no pertenece a** AA y escribimos a∉Aa∉A. En el último ejemplo, 12∈A12∈A y 5∉A5∉A.
-